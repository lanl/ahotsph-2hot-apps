...
void o4(double *a0, double *a1, double *a2, double *pp, float x, float y, float z, float *Q)
{
    ...
    *pp += t * (Q[1] + Q[4]*x3 + x4 - 0.6666666666666666*Q[7]*y3 + y4 + Q[9]*z + y2*(Q[8] + Q[11]*z - 3.*z2) + x2*(Q[3] + Q[7]*y - 3.*y2 + Q[11]*z - 3.*z2) + Q[13]*z2 + x*(Q[2] + Q[6]*y - 1.5*Q[4]*y2 + Q[10]*z - 1.5*Q[4]*z2) + y*(Q[5] + Q[12]*z + Q[7]*z2) - 0.6666666666666666*Q[11]*z3 + z4);
    *a0 -= t * (Q[2] + 3.*Q[4]*x2 + 4.*x3 + Q[6]*y - 1.5*Q[4]*y2 + Q[10]*z + 2.*x*(Q[3] + Q[7]*y - 3.*y2 + Q[11]*z - 3.*z2) - 1.5*Q[4]*z2);
    *a1 -= t * (Q[5] + x2*(Q[7] - 6.*y) + x*(Q[6] - 3.*Q[4]*y) - 2.*Q[7]*y2 + 4.*y3 + Q[12]*z + 2.*y*(Q[8] + Q[11]*z - 3.*z2) + Q[7]*z2);
    *a2 -= t * (Q[9] + x2*(Q[11] - 6.*z) + y2*(Q[11] - 6.*z) + 2.*Q[13]*z + x*(Q[10] - 3.*Q[4]*z) + y*(Q[12] + 2.*Q[7]*z) - 2.*Q[11]*z2 + 4.*z3);
}
...
void o6(double *a0, double *a1, double *a2, double *pp, float x, float y, float z, float *Q)
{
    ...
    *pp += t * (Q[14] + 1.5*Q[4]*x5 + x6 - 1.*Q[7]*y5 + y6 + Q[22]*z + Q[28]*z2 - 2.5*y4*(-1.*Q[8] - 1.*Q[11]*z + 3.*z2) - 2.5*x4*(-1.*Q[3] - 1.*Q[7]*y + 3.*y2 - 1.*Q[11]*z + 3.*z2) - 2.5*x3*(-2.*Q[2] - 2.*Q[6]*y + 3.*Q[4]*y2 - 2.*Q[10]*z + 3.*Q[4]*z2) + 5.*y3*(Q[5] + Q[12]*z + Q[7]*z2) + 5.*Q[9]*z3 + y2*(Q[20] + Q[27]*z + 15.*Q[3]*z2 + 5.*Q[11]*z3 - 7.5*z4) + x2*(Q[16] + 5.*Q[7]*y3 - 7.5*y4 + Q[24]*z + 15.*Q[8]*z2 + 15.*y2*(Q[13] - 2.*Q[11]*z + 6.*z2) + y*(Q[19] - 30.*Q[12]*z - 30.*Q[7]*z2) + 5.*Q[11]*z3 - 7.5*z4) + 2.5*Q[13]*z4 + x*(Q[15] + 5.*Q[6]*y3 - 3.75*Q[4]*y4 + Q[23]*z + y*(Q[18] + z*(Q[26] - 30.*Q[6]*z)) + Q[29]*z2 + y2*(Q[21] - 30.*Q[10]*z + 45.*Q[4]*z2) + 5.*Q[10]*z3 - 3.75*Q[4]*z4) + y*(Q[17] + Q[25]*z + Q[30]*z2 + 5.*Q[12]*z3 + 2.5*Q[7]*z4) - 1.*Q[11]*z5 + z6);
    *a0 -= t * (Q[15] + 7.5*Q[4]*x4 + 6.*x5 + 5.*Q[6]*y3 - 3.75*Q[4]*y4 + Q[23]*z + y*(Q[18] + z*(Q[26] - 30.*Q[6]*z)) + Q[29]*z2 - 10.*x3*(-1.*Q[3] - 1.*Q[7]*y + 3.*y2 - 1.*Q[11]*z + 3.*z2) - 7.5*x2*(-2.*Q[2] - 2.*Q[6]*y + 3.*Q[4]*y2 - 2.*Q[10]*z + 3.*Q[4]*z2) + y2*(Q[21] - 30.*Q[10]*z + 45.*Q[4]*z2) + 5.*Q[10]*z3 + x*(2.*Q[16] + 10.*Q[7]*y3 - 15.*y4 + 2.*Q[24]*z + 30.*Q[8]*z2 + 30.*y2*(Q[13] - 2.*Q[11]*z + 6.*z2) + y*(2.*Q[19] - 60.*Q[12]*z - 60.*Q[7]*z2) + 10.*Q[11]*z3 - 15.*z4) - 3.75*Q[4]*z4);
    *a1 -= t * (Q[17] + 2.5*x4*(Q[7] - 6.*y) + 5.*x3*(Q[6] - 3.*Q[4]*y) - 5.*Q[7]*y4 + 6.*y5 + Q[25]*z + 10.*y3*(Q[8] + Q[11]*z - 3.*z2) + Q[30]*z2 + 15.*y2*(Q[5] + Q[12]*z + Q[7]*z2) + x2*(Q[19] + 15.*Q[7]*y2 - 30.*y3 - 30.*Q[12]*z - 30.*Q[7]*z2 + 30.*y*(Q[13] - 2.*Q[11]*z + 6.*z2)) + x*(Q[18] + 15.*Q[6]*y2 - 15.*Q[4]*y3 + z*(Q[26] - 30.*Q[6]*z) + 2.*y*(Q[21] - 30.*Q[10]*z + 45.*Q[4]*z2)) + 5.*Q[12]*z3 + y*(2.*Q[20] + 2.*Q[27]*z + 30.*Q[3]*z2 + 10.*Q[11]*z3 - 15.*z4) + 2.5*Q[7]*z4);
    *a2 -= t * (Q[22] + 2.5*x4*(Q[11] - 6.*z) + 2.5*y4*(Q[11] - 6.*z) + 2.*Q[28]*z + 5.*x3*(Q[10] - 3.*Q[4]*z) + 5.*y3*(Q[12] + 2.*Q[7]*z) + 15.*Q[9]*z2 + y2*(Q[27] + 30.*Q[3]*z + 15.*Q[11]*z2 - 30.*z3) + x2*(Q[24] + 30.*Q[8]*z + 30.*y2*(-1.*Q[11] + 6.*z) - 30.*y*(Q[12] + 2.*Q[7]*z) + 15.*Q[11]*z2 - 30.*z3) + 10.*Q[13]*z3 + x*(Q[23] + 2.*Q[29]*z - 30.*y2*(Q[10] - 3.*Q[4]*z) + y*(Q[26] - 60.*Q[6]*z) + 15.*Q[10]*z2 - 15.*Q[4]*z3) + y*(Q[25] + 2.*Q[30]*z + 15.*Q[12]*z2 + 10.*Q[7]*z3) - 5.*Q[11]*z4 + 6.*z5);
}
...
void o8(double *a0, double *a1, double *a2, double *pp, float x, float y, float z, float *Q)
{
    ...
    *pp += t * (Q[31] + 2.*Q[4]*x7 + x8 - 1.3333333333333333*Q[7]*y7 + y8 + Q[48]*z + Q[57]*z2 - 4.666666666666667*y6*(-1.*Q[8] - 1.*Q[11]*z + 3.*z2) - 4.666666666666667*x6*(-1.*Q[3] - 1.*Q[7]*y + 3.*y2 - 1.*Q[11]*z + 3.*z2) - 7.*x5*(-2.*Q[2] - 2.*Q[6]*y + 3.*Q[4]*y2 - 2.*Q[10]*z + 3.*Q[4]*z2) + 14.*y5*(Q[5] + Q[12]*z + Q[7]*z2) + Q[66]*z3 + Q[67]*z4 + x4*(Q[35] + Q[40]*y + Q[45]*y2 - 23.333333333333332*Q[7]*y3 + 35.*y4 + Q[52]*z + Q[61]*z2 - 23.333333333333332*Q[11]*z3 + 35.*z4) + y4*(Q[47] + Q[56]*z + Q[65]*z2 - 23.333333333333332*Q[11]*z3 + 35.*z4) + x3*(Q[34] + Q[39]*y + Q[44]*y2 - 46.666666666666664*Q[6]*y3 + 35.*Q[4]*y4 + Q[51]*z + Q[60]*z2 - 46.666666666666664*Q[10]*z3 + 35.*Q[4]*z4) + y3*(Q[46] + Q[55]*z + Q[64]*z2 - 46.666666666666664*Q[12]*z3 - 23.333333333333332*Q[7]*z4) + 14.*Q[9]*z5 + x2*(Q[33] + Q[38]*y + Q[43]*y2 - 2.*Q[40]*y3 - 1.*Q[45]*y4 + 14.*Q[7]*y5 - 14.*y6 + Q[50]*z + Q[59]*z2 - 2.*Q[52]*z3 - 1.*Q[61]*z4 + 14.*Q[11]*z5 - 14.*z6) + y2*(Q[41] + Q[54]*z + Q[63]*z2 - 2.*Q[56]*z3 - 1.*Q[65]*z4 + 14.*Q[11]*z5 - 14.*z6) + 4.666666666666667*Q[13]*z6 + x*(Q[32] + Q[37]*y + Q[42]*y2 - 1.*Q[39]*y3 - 0.5*Q[44]*y4 + 14.*Q[6]*y5 - 7.*Q[4]*y6 + Q[49]*z + Q[58]*z2 - 1.*Q[51]*z3 - 0.5*Q[60]*z4 + 14.*Q[10]*z5 - 7.*Q[4]*z6) + y*(Q[36] + Q[53]*z + Q[62]*z2 - 1.*Q[55]*z3 - 0.5*Q[64]*z4 + 14.*Q[12]*z5 + 4.666666666666667*Q[7]*z6) - 1.3333333333333333*Q[11]*z7 + z8);
    *a0 -= t * (Q[32] + 14.*Q[4]*x6 + 8.*x7 + Q[37]*y + Q[42]*y2 - 1.*Q[39]*y3 - 0.5*Q[44]*y4 + 14.*Q[6]*y5 - 7.*Q[4]*y6 + Q[49]*z + Q[58]*z2 - 28.*x5*(-1.*Q[3] - 1.*Q[7]*y + 3.*y2 - 1.*Q[11]*z + 3.*z2) - 35.*x4*(-2.*Q[2] - 2.*Q[6]*y + 3.*Q[4]*y2 - 2.*Q[10]*z + 3.*Q[4]*z2) - 1.*Q[51]*z3 - 0.5*Q[60]*z4 + 1.3333333333333333*x3*(3.*Q[35] + 3.*Q[40]*y + 3.*Q[45]*y2 - 70.*Q[7]*y3 + 105.*y4 + 3.*Q[52]*z + 3.*Q[61]*z2 - 70.*Q[11]*z3 + 105.*z4) + x2*(3.*Q[34] + 3.*Q[39]*y + 3.*Q[44]*y2 - 140.*Q[6]*y3 + 105.*Q[4]*y4 + 3.*Q[51]*z + 3.*Q[60]*z2 - 140.*Q[10]*z3 + 105.*Q[4]*z4) + 14.*Q[10]*z5 + 2.*x*(Q[33] + Q[38]*y + Q[43]*y2 - 2.*Q[40]*y3 - 1.*Q[45]*y4 + 14.*Q[7]*y5 - 14.*y6 + Q[50]*z + Q[59]*z2 - 2.*Q[52]*z3 - 1.*Q[61]*z4 + 14.*Q[11]*z5 - 14.*z6) - 7.*Q[4]*z6);
    *a1 -= t * (Q[36] + 4.666666666666667*x6*(Q[7] - 6.*y) + 14.*x5*(Q[6] - 3.*Q[4]*y) + x3*(Q[39] + 2.*y*(Q[44] + 70.*y*(-1.*Q[6] + Q[4]*y))) + x4*(Q[40] + 2.*Q[45]*y - 70.*Q[7]*y2 + 140.*y3) + x*(Q[37] + y*(2.*Q[42] - 3.*Q[39]*y - 2.*Q[44]*y2 + 70.*Q[6]*y3 - 42.*Q[4]*y4)) + x2*(Q[38] + 2.*Q[43]*y - 6.*Q[40]*y2 - 4.*Q[45]*y3 + 70.*Q[7]*y4 - 84.*y5) - 9.333333333333334*Q[7]*y6 + 8.*y7 + Q[53]*z + 28.*y5*(Q[8] + Q[11]*z - 3.*z2) + Q[62]*z2 + 70.*y4*(Q[5] + Q[12]*z + Q[7]*z2) - 1.*Q[55]*z3 - 0.5*Q[64]*z4 + 1.3333333333333333*y3*(3.*Q[47] + 3.*Q[56]*z + 3.*Q[65]*z2 - 70.*Q[11]*z3 + 105.*z4) + y2*(3.*Q[46] + 3.*Q[55]*z + 3.*Q[64]*z2 - 140.*Q[12]*z3 - 70.*Q[7]*z4) + 14.*Q[12]*z5 + 2.*y*(Q[41] + Q[54]*z + Q[63]*z2 - 2.*Q[56]*z3 - 1.*Q[65]*z4 + 14.*Q[11]*z5 - 14.*z6) + 4.666666666666667*Q[7]*z6);
    *a2 -= t * (Q[48] + 4.666666666666667*x6*(Q[11] - 6.*z) + 4.666666666666667*y6*(Q[11] - 6.*z) + 2.*Q[57]*z + 14.*x5*(Q[10] - 3.*Q[4]*z) + 14.*y5*(Q[12] + 2.*Q[7]*z) + 3.*Q[66]*z2 + 4.*Q[67]*z3 + x4*(Q[52] + 2.*Q[61]*z - 70.*Q[11]*z2 + 140.*z3) + y4*(Q[56] + 2.*Q[65]*z - 70.*Q[11]*z2 + 140.*z3) + x3*(Q[51] + 2.*Q[60]*z - 140.*Q[10]*z2 + 140.*Q[4]*z3) + y3*(Q[55] + 2.*Q[64]*z - 140.*Q[12]*z2 - 93.33333333333333*Q[7]*z3) + 70.*Q[9]*z4 + x2*(Q[50] + 2.*Q[59]*z - 6.*Q[52]*z2 - 4.*Q[61]*z3 + 70.*Q[11]*z4 - 84.*z5) + y2*(Q[54] + 2.*Q[63]*z - 6.*Q[56]*z2 - 4.*Q[65]*z3 + 70.*Q[11]*z4 - 84.*z5) + 28.*Q[13]*z5 + x*(Q[49] + 2.*Q[58]*z - 3.*Q[51]*z2 - 2.*Q[60]*z3 + 70.*Q[10]*z4 - 42.*Q[4]*z5) + y*(Q[53] + 2.*Q[62]*z - 3.*Q[55]*z2 - 2.*Q[64]*z3 + 70.*Q[12]*z4 + 28.*Q[7]*z5) - 9.333333333333334*Q[11]*z6 + 8.*z7);
}
