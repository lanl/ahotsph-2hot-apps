...
main(int argc, char *argv[])
{
    ...
    SetupTree(&thetree, NDIM, sizeof(body), sizeof(cell), 0, 0, TBODYSZ,
              sizeof(cofmdata), (pq_keyproto)GetKeyFromStruct,
              (pq_wgtproto)GetCost, CofmFromDaugh,
              (cellfromcofm_t)CellFromCofm, CellSz);
    ...
    SetupTree(&SPHsinktree, NDIM, sizeof(SPHbody), sizeof(SPHcell), 0, 0,
              SPHTBODYSZ, sizeof(SPHcofmdata),
	      (pq_keyproto)SPHGetKeyFromStruct, (pq_wgtproto)SPHGetCost,
	      SPHCofmFromDaugh, (cellfromcofm_t)SPHCellFromCofm, SPHCellSz);
