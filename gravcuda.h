...
EXTERN void grav_mn_CUDA(const char *routine,
                         const float *p,
                         float *accp,
                         const int n,
                         const int stride,
                         ...
                         int *ncut,
                         int q);
EXTERN void grav_mns_CUDA(const char *routine,
                          const int base,
                          const int m,
                          const segment *seg,
                          const int seg_n,
                          ...
                          int *ncut,
                          int q);
EXTERN void grav_mnss_CUDA(const char *routine,
                           const int sink_base,
                           const int m,
                           ...
                           int *ncut,
                           int q);
EXTERN void grav_qns_CUDA(const char *routine,
                          const int base,
                          const int m,
                          const int *source_list,
                          const int source_n,
                          int q);
EXTERN void grav_qnss_CUDA(const char *routine,
                           const int base,
                           const int m,
                           const segment *seg,
                           const float *source,
...
inline static void grav_mn_CUDA(const char *routine,
                                const float *p,
                                float *accp,
                                const int n,
                                const int stride,
                                ...
                                int *ncut,
                                int q) {}
inline static void grav_mns_CUDA(const char *routine,
                                 const int base,
                                 const int m,
                                 const segment *seg,
                                 const int seg_n,
                                 ...
                                 int *ncut,
                                 int q) {}
inline static void grav_mnss_CUDA(const char *routine,
                                  const int sink_base,
                                  const int m,
                                  const uint16_t *ss_index,
                                  const segment *ss_seg,
                                  ...
                                  int *ncut,
                                  int q) {}
inline static void grav_qns_CUDA(
    const char *routine, const int base, const int m, const int *source_list, const int source_n){};
inline static void grav_qnss_CUDA(const char *routine,
                                  const int base,
                                  const int m,
                                  const segment *seg,
                                  const float *source,
