...
/* 217 flops, 100 bytes */
void do_gravdh_sse4(const v4sf *f,
                    const v4sf *fend,
                    const float *pos0,
                    float *mass0,
                    float *acc,
    ...
    const v4sf third
        = {(float)(1.0 / 3.0), (float)(1.0 / 3.0), (float)(1.0 / 3.0), (float)(1.0 / 3.0)};
    ...
    while (f < fend) {
        ...
        xyz = xy * z;
        eq0 = t
              * (qxxxx * xxx + qxyyy * yyy + qxxxy * xxy + qxxxz * xxz + qxxyy * xyy + qxxyz * xyz
                 + qxyyz * yyz);
        eq1 = t
              * (qxyyy * xyy + qxxxy * xxx + qyyyy * yyy + qyyyz * yyz + qxxyy * xxy + qxxyz * xxz
                 + qxyyz * xyz);
        eq2 = t
...
void do_gravdh_amd6100_sse4(const v4sf *f,
                            const v4sf *fend,
                            const float *pos0,
                            float *mass0,
                            float *acc,
...
/* 66 flops, 40 bytes */
void do_gravdq_sse4(const v4sf *f,
                    const v4sf *fend,
                    const float *pos0,
                    float *mass0,
                    float *acc,
...
void do_gravdqq_sse4(const float *q,
                     const int stride,
                     const int *ii,
                     const int n,
                     const float *pos0,
...
/* 217 flops, 100 bytes */
void do_gravh_sse4(const v4sf *f,
                   const v4sf *fend,
                   const float *pos0,
                   float *mass0,
                   float *acc,
...
void do_gravh_amd6100_sse4(const v4sf *f,
                           const v4sf *fend,
                           const float *pos0,
                           float *mass0,
                           float *acc,
...
/* 66 flops, 40 bytes */
void do_gravq_sse4(const v4sf *f,
                   const v4sf *fend,
                   const float *pos0,
                   float *mass0,
                   float *acc,
...
/* 26 flops, 16 bytes */
void do_grav_sse4(const v4sf *f,
                  const v4sf *fend,
                  const float *pos0,
                  float *mass0,
                  float *acc,
...
static sret_s sK1(const v4sf r2, const float e) {
    sret_s r;
...
void do_grav_sK1_sse4(const v4sf *f,
                      const v4sf *fend,
                      const float *pos0,
                      float *mass0,
                      float *acc,
...
void do_gravmm_sK1_sse4(const float *xyz,
                        const int stride,
                        const float pmass,
                        const segment *mm,
                        const int mm_n,
...
void do_gravsS_sse4(const v4sf *f,
                    const v4sf *fend,
                    const float *pos0,
                    float *mass0,
                    float *acc,
...
void do_gravsF1_sse4(const v4sf *f,
                     const v4sf *fend,
                     const float *pos0,
                     float *mass0,
                     float *acc,
...
void do_gravsF2_sse4(const v4sf *f,
                     const v4sf *fend,
                     const float *pos0,
                     float *mass0,
                     float *acc,
...
/* Dehnen K1 Compensating Kernel */
void do_gravsK1_sse4(const v4sf *f,
                     const v4sf *fend,
                     const float *pos0,
                     float *mass0,
                     float *acc,
...
void do_gravsU_sse4(const v4sf *f,
                    const v4sf *fend,
                    const float *pos0,
                    float *mass0,
                    float *acc,
...
void do_gravsCP_sse4(const v4sf *f,
                     const v4sf *fend,
                     const float *pos0,
                     float *mass0,
                     float *acc,
...
void do_grav11bits_sse4(const v4sf *f,
                        const v4sf *fend,
                        const float *pos0,
                        float *mass0,
                        float *acc,
...
void do_gravph_sse4(const v4sf *f,
                    const v4sf *fend,
                    const float *pos0,
                    float *mass0,
                    float *acc,
...
void do_gravph_amd6100_sse4(const v4sf *f,
                            const v4sf *fend,
                            const float *pos0,
                            float *mass0,
                            float *acc,
...
void do_gravpq_sse4(const v4sf *f,
                    const v4sf *fend,
                    const float *pos0,
                    float *mass0,
                    float *acc,
...
void do_gravp_sse4(const v4sf *f,
                   const v4sf *fend,
                   const float *pos0,
                   float *mass0,
                   float *acc,
...
void do_gravp11bits_sse4(const v4sf *f,
                         const v4sf *fend,
                         const float *pos0,
                         float *mass0,
                         float *acc,
