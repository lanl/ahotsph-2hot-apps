...
#define Vdecl(a, s) { \
    ...
    {a[(s)*(index*VECWIDTH+2)+0], a[(s)*(index*VECWIDTH+2)+1], a[(s)*(index*VECWIDTH+2)+2]}, \
    {a[(s)*(index*VECWIDTH+3)+0], a[(s)*(index*VECWIDTH+3)+1], a[(s)*(index*VECWIDTH+3)+2]}, \
    {a[(s)*(index*VECWIDTH+4)+0], a[(s)*(index*VECWIDTH+4)+1], a[(s)*(index*VECWIDTH+4)+2]}, \
    {a[(s)*(index*VECWIDTH+5)+0], a[(s)*(index*VECWIDTH+5)+1], a[(s)*(index*VECWIDTH+5)+2]}}

#define V4decl(a) {a[index], a[index+1], a[index+2], a[index+3], a[index+4], a[index+5]}
...
#define Vdecl(a, s) { \
    ...
    {a[(s)*(index*VECWIDTH+4)+0], a[(s)*(index*VECWIDTH+4)+1], a[(s)*(index*VECWIDTH+4)+2]}, \
    {a[(s)*(index*VECWIDTH+5)+0], a[(s)*(index*VECWIDTH+5)+1], a[(s)*(index*VECWIDTH+5)+2]}, \
    {a[(s)*(index*VECWIDTH+6)+0], a[(s)*(index*VECWIDTH+6)+1], a[(s)*(index*VECWIDTH+6)+2]}, \
    {a[(s)*(index*VECWIDTH+7)+0], a[(s)*(index*VECWIDTH+7)+1], a[(s)*(index*VECWIDTH+7)+2]}}

#define V4decl(a) {a[index], a[index+1], a[index+2], a[index+3], a[index+4], a[index+5], a[index+6], a[index+7]}
